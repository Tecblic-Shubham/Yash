...
pyautogui.write('https://dev.thesciencepark.dev/')
...
pyautogui.click()
pyautogui.write('trtrt8080@gmail.com', interval=0.25)  # type with quarter-second pause in between each key
pyautogui.press('tab')
pyautogui.write('0987', interval=0.25)
