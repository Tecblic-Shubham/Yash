...
def get_house_links( driver):
    ...
    for city in cities:
        for i in range(1,10):
            ...
            # driver.get("https://www.magicbricks.com/Real-estate-projects-Search/residential-new-project?&proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName="+str(city)+"&bedrooms=11701,11702&postedSince=-1&mbTrackSrc=tabChange&isNRI=N&page="+str(i)+"&category=S")
